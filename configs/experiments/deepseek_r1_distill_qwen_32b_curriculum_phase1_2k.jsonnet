// 32B Phase 1 (2K max response length) — easy-to-hard curriculum, 500 iter.
local base = import 'deepseek_r1_distill_qwen_32b_mainline_rl.jsonnet';
local processed_root = './train_data/Big-Math-RL-Verified-Processed';

local phase_cfg = {
  exp_name: 'deepseek_r1_distill_qwen_32b_curriculum_phase1_2k',
  output_dir: 'experiments/deepseek_r1_distill_qwen_32b_curriculum_phase1_2k',
